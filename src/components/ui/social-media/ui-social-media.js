...
export class UiSocialMedia extends HTMLElement {
    ...
    render() {
        ...
        this.setHTMLUnsafe(`
            <nav class="fx-jsc_c gap-4">
              <a href="${link.linkedin}" class="fx" alt="linkedin" title="LinkedIn" target="_blank" rel="noopener noreferrer">
              ...
              <a href="${link.github}" class="fx" alt="github" title="GitHub" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <a href="${link.dribbble}" style="display: none" class="fx" alt="dribbble" title="Dribbble" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor">
              ...
              <a href="${link.pinterest}" class="fx" alt="pinterest" title="Pinterest" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor">
